hrApp.controller('EmployeeListController', ['$scope', '$http','$route', '$location', 'CommonResourcesFactoryBackup','EmployeeService',
    function ($scope, $http,$route, $location, CommonResourcesFactoryBackup,EmployeeService) {
        ...
        $scope.deleteEmployee = function (employeeId) {
            EmployeeService.deleteOne(employeeId)
                .then(function (res) {
                    ...
                    console.log("Error at employees/findOne: " + error.status);
                });
        };
